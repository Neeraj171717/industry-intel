    ...
    return (
      <div className="min-h-screen bg-[#0D1117]">
        <div className="md:flex md:items-start md:max-w-[1400px] md:mx-auto">
          ...
          <main className="flex-1 min-w-0 px-4 md:px-8 pt-6 space-y-3">
            {[...Array(5)].map((_, i) => (
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="hidden md:flex items-center justify-between h-16 px-8 border-b border-[#1A2030] sticky top-0 bg-[#0D1117]/95 backdrop-blur z-30">
            <div className="flex items-center gap-2">
              <h1 className="text-white font-bold text-[20px]">Notifications</h1>
              {unreadCount > 0 && (
            ...
            {unreadCount > 0 && (
              <button onClick={markAllRead} className="text-[13px] text-[#444D5A] hover:text-white font-medium transition-colors">
                Mark all read
              </button>
            )}
          </div>
          ...
          <div className="pb-[72px] md:pb-10 max-w-[860px] md:mx-auto">
            ...
            {/* Notification list */}
            {notifications.length > 0 && (
              <div className="px-4 md:px-8 pt-3 md:pt-6 space-y-2">
                {notifications.map(n => {
